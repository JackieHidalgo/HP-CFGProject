...
def begin_round(player_score, computer_score):
    ...
    if player_characteristic == opponent_characteristic:
        print('Its a draw!')
    print(player_colour + '{} score: {}'.format(player_name, player_score))
    print(opponent_colour + 'Opponent\'s score: {}'.format(computer_score))
    next_round = input('Press enter to continue to your next duel! ')
...
print(player_colour + "{} point to {}!".format(player_score, player_house))
